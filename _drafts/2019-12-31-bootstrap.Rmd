...
rate, and the latter indicates the smallest effect that we still care about;
anything smaller is as good as zero for any practical purpose. Furthermore, we
know what statistical power we would like the test to have, which constrains the
false negative rate.
