...
and the metric could the average value:

```
Metric(Sample) = Sum of observations / Number of observations.
```

Note, however, that is is an example; the metric can be arbitrary, and this is a
prominent advantage of this approach to sample size determination based on data
and simulation.
...
The goal of simulation is to obtain the distribution of the test statistic for
two cases: under the null hypothesis and under the alternative hypothesis. Given
