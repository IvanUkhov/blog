...
to have a prescribed false negative rate $$\beta$$, ensiring that the test have
...
![](/assets/images/2019-12-31-bootstrap/sampling-distribution-1.svg)
...
designed in terms of the level of statistical significance $$\alpha$$, the false
negative rate $$\beta$$, and the level of practical significance $$\delta$$.
...
is based historical data and simulation rather than mathematical formulae
