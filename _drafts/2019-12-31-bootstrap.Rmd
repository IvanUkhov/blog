...
size parameter until we find the smallest value allowing the test to satisfy the
requirements that were imposed on it; recall $$\alpha$$, $$\beta$$, and
$$\delta$$ in the previous section.
