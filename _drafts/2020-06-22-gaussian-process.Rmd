...
but unknown function, and $$\epsilon_i$$ represents the perturbation of the
...
covariance funcction dectates the amount of correlation between two arbitrary
locations
$$\mathbf{x}$$ and $$\mathbf{x}'$$ in $$\mathbb{R}^d$$.
