...
Here are five draws from these priors, including Equations (2) and (3):
...
The heavy tails for the intercept allow the noise to vary widely from small to
large values. The large ones are perhaps unrealistic, given the scale of the
response, and could be addressed by shifting the distribution. However, they
should not cause problems for the inference.
