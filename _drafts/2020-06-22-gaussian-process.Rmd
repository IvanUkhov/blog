...
This concludes the modeling part. The remaining step is infer the parameters and
subsequently make predictions using the posterior predictive distribution.
...
The inferred parameters are as follows:
...
```{r posterior-predictive, cache = TRUE, include = FALSE}
posterior_predictive_plot(model, data$x, data$x, data$y)
```

![](/assets/images/2020-06-22-gaussian-process/posterior-predictive-1.svg)
