...
```{r direct-prior, fig.asp = 1, include = FALSE}
set.seed(42)
...
```{r direct-posterior, fig.asp = 1, include = FALSE}
set.seed(42)
...
cache_path <- file.path(cache_directory, 'mixture-prior-draws.RData')
...
cache_path <- file.path(cache_directory, 'mixture-posterior-draws.RData')
if (!file.exists(cache_path)) {
  set.seed(42)
